...
export function loadBatchMint(slice: Slice) {
    let sc_0 = slice;
    if (sc_0.loadUint(32) !== 2432039616) { throw Error('Invalid prefix'); }
    let _query_id = sc_0.loadUintBig(64);
...
function storeTupleBatchMint(source: BatchMint) {
    ...
    builder.writeCell(source.items.size > 0 ? beginCell().storeDictDirect(source.items, Dictionary.Keys.BigInt(257), Dictionary.Values.Cell()).endCell() : null);
    return builder.build();
}
...
export function loadSetCollectionMetaData(slice: Slice) {
    let sc_0 = slice;
    if (sc_0.loadUint(32) !== 3836233402) { throw Error('Invalid prefix'); }
    let _query_id = sc_0.loadUintBig(64);
    let _new_collection_content = sc_0.loadRef();
    return { $$type: 'SetCollectionMetaData' as const, query_id: _query_id, new_collection_content: _new_collection_content };
}
...
async function NftItem_init(collection_address: Address, item_index: bigint, owner: Address, individual_content: Cell) {
    const __code = Cell.fromBase64('');
    const __system = Cell.fromBase64('');
...
const NftItem_types: ABIType[] = [
    ...
    {"name":"BatchMint","header":2432039616,"fields":[{"name":"query_id","type":{"kind":"simple","type":"uint","optional":false,"format":64}},{"name":"size","type":{"kind":"simple","type":"uint","optional":false,"format":8}},{"name":"items","type":{"kind":"dict","key":"int","value":"cell","valueFormat":"ref"}}]},
    {"name":"SetCollectionMetaData","header":3836233402,"fields":[{"name":"query_id","type":{"kind":"simple","type":"uint","optional":false,"format":64}},{"name":"new_collection_content","type":{"kind":"simple","type":"cell","optional":false}}]},
