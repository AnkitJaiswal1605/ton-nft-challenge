...
export async function run(provider: NetworkProvider) {
    ...
    const metadata_link = "https://olive-late-seahorse-104.mypinata.cloud/ipfs/QmX6fM6JswHdab9MXSAx82YsexE83cWCws3WbEGGbgj4qW/?pinataGatewayToken=TwBnfthzHwwEaeKaj_gJcN1Zn9AbQYKVGvyATB2aOczNlUMGSfhWxIrX84XcvOvq"
